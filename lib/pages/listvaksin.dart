...
class listvaksin extends StatefulWidget {
  ImunisasiGroup imunisasi;

  listvaksin(this.imunisasi);

  @override
  State<listvaksin> createState() => _listvaksinState();
}

class _listvaksinState extends State<listvaksin> {
  @override
